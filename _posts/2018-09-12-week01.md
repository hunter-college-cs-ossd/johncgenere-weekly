...
2. Distinguishing between Free Software and Open Source, noting that Open Source should be
   ...
   whatever one likes with the code, such as building upon it to fulfill their current need or 
   give it to a friend. 
3. Developed the GNU General Public License (or the GNU GPL) which was designed to 
   ...
   GPL protect the user's freedom but in the case where a user wanted to create another version 
